                ...
                <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start mb-4">
                        <div>
                            ...
                            <p class="card-subtitle card-subtitle-dash">Create a new department for the clinic</p>
                        </div>
                    </div>

                    <form class="forms-sample" action="{{ route('specialties.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="icon" class="form-control" placeholder="mdi-heart-pulse">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="fw-bold small">Description</label>
                            <textarea name="description" class="form-control" rows="4" placeholder="Brief overview of the specialty..."></textarea>
                        </div>
                        ...
                        <div class="mt-4 border-top pt-4 text-end">
                            ...
                            <button type="submit" class="btn btn-primary text-white px-4">Create Specialty</button>
                        </div>
                    </form>
                </div>
            </div>
