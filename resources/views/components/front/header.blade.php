    ...
    <div
        ...
        <a href="#" class="logo d-flex align-items-center me-auto me-xl-0">
            ...
            <svg class="my-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="iconCarrier">
                    ...
                    <path opacity="0.5" d="M10 12H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
                    </path>
                    <path opacity="0.5" d="M5.5 11H7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
                    </path>
                    <path opacity="0.5" d="M5.5 14H7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
                    </path>
                    <path opacity="0.5" d="M17 11H18.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
                    </path>
                    <path opacity="0.5" d="M17 14H18.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
                    </path>
                    <path opacity="0.5" d="M5.5 8H7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
                    </path>
                    <path opacity="0.5" d="M17 8H18.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round">
                    </path>
        ...
        @if (!Auth::guard('patient')->check())
            <div class="d-flex align-items-center">
                <a class="btn-getstarted d-none d-sm-block" href="{{ route('front.appointments.create') }}">Appointment</a>
                <div>
        ...
        @else
            <div class="dropdown patient-profile-dropdown">
                <button class="btn dropdown-toggle d-flex align-items-center p-0 border-0" type="button" id="patientMenu"
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow border-0" aria-labelledby="patientMenu">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center py-2" href="{{ route('front.profile.index') }}">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center py-2" href="{{ route('profile.edit') }}">
                            <i class="bi bi-lock-fill me-2 text-info"></i>
                            <span>Security</span>
                        </a>
                    </li>
                    <li>
